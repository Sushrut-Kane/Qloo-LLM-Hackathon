...
class QlooService {
  ...
  constructor() {
    this.apiKey = import.meta.env.VITE_QLOO_API_KEY || 'IRp90lw_OS-XPWCk2pkrtjPo94itrBRsR8f_X24Z0Ms';
    this.baseUrl = import.meta.env.VITE_QLOO_API_URL || 'https://hackathon.api.qloo.com';
  }
