...
const qlooApiUrl = import.meta.env.VITE_QLOO_API_URL || 'https://hackathon.api.qloo.com';
const qlooApiKey = import.meta.env.VITE_QLOO_API_KEY || 'IRp90lw_OS-XPWCk2pkrtjPo94itrBRsR8f_X24Z0Ms';
